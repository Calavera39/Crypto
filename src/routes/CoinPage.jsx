    ...
    return (
        ...
        <div className='rounded-div my-12 py-8'>
            ...
            <div className='flex py-8'>
                <img className='w-20 mr-8' src={coin.image?.large} alt={coin?.name}></img>
                <div>
            ...
            <div className='grid md:grid-cols-2 gap-8'>
                ...
                <div>
                    ...
                    <div className='flex justify-between py-4 ic'>
                        <div>
                    ...
                    <div>
                        <a href='https://github.com/Calavera39' target='_blank' rel='noreferrer'>
                            <FaGithub className='w-full h-10 m-4c cursor-pointer'/>
                        </a>
                    </div>
                    </div>
